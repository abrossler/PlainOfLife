...
function prepare(allCellContainers?: ExtCellContainer<RuleExtensionFactory>[]): {mappings: SerializationMapping<any, any>[], objectLists: any} {
    let mappings: SerializationMapping<any, any>[] = [dateMapping, Uint16Mapping]
  let objectLists: any = { }
  if( allCellContainers ){
    mappings.push(cellContainerMapping)
...
type SerializationMapping<T, U> = {toMap:new()=>T, mapAs: string, mapTo: (toMap:T, mapAs:string, objectLists: ObjectLists)=>U, mapFrom: (toMap: U, mapAs:string, objectLists: ObjectLists)=>T}
...
function mapFromIndex<T>( index: number, mapAs: string, objectLists: ObjectLists): T {
  ...
  let testClassMapping: SerializationMapping<TestClass, number> = {
    toMap: TestClass,
    mapAs: '__TestClass__',
    mapTo: mapToIndex,
  ...
  let cellContainerMapping: SerializationMapping<CellContainer<RuleExtensionFactory>, number> = {
  ...
  let dateMapping: SerializationMapping<Date, string> = {
      toMap: Date,
      mapAs: '__Date__',
  ...
  let Uint16Mapping: SerializationMapping<Uint16Array, string> = {
      toMap: Uint16Array,
  ...
  function toSerializable2(from: unknown,
  ...
  function fromSerializable2(from: unknown,
    mappings: SerializationMapping<any, any>[],
    objectLists: ObjectLists = {} ) {
